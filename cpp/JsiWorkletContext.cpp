...
JsiWorkletContext::createCallInContext(jsi::Runtime &runtime,
  ...
  std::shared_ptr<JsiWorklet> worklet =
  ...
  return [worklet, func,
    ...
    if (convention == CallingConvention::JsToJs ||
      ...
      auto promise = std::make_shared<JsiPromiseWrapper>(
          runtime,
          [worklet, thisWrapper, argsWrapper, func, count](
              jsi::Runtime &runtime,
    ...
    auto promise = std::make_shared<JsiPromiseWrapper>(
        runtime,
        [worklet, thisWrapper, argsWrapper, callIntoCorrectContext, callback,
         func](
            jsi::Runtime &runtime,
            std::function<void(jsi::Runtime & runtime, const jsi::Value &val)>
                resolve,

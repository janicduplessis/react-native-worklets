...
export type ContextType = {
    [key: string]: number | string | boolean | undefined | null | ISharedValue<any> | ContextType | ContextType[] | number[] | string[] | boolean[] | IWorklet;
};
export interface IWorkletNativeApi {
     ...
     */
    createRunInContextFn: <C extends ContextType, T, A extends Array<unknown>>(fn: (this: C, ...args: A) => T, context?: IWorkletContext) => (...args: A) => Promise<T>;
    /**
     ...
     */
    createRunInJsFn: <C extends ContextType, T, A extends Array<unknown>>(fn: (this: C, ...args: A) => T) => (...args: A) => Promise<T>;
    /**
...
export declare const Worklets: IWorkletNativeApi;
